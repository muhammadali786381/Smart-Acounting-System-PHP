              ...
              <div class="card-body">
                <table id="list" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td><a href="<?php echo BASE_URL.ADMIN_DIR; ?>/users/administrator/<?php echo $row['admin_id']; ?>" target="__blank" title="Detail" class="btn btn-outline-danger"><i class="fa fa-eye"></i></a></td>
                  </tr>
