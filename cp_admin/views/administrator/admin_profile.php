  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Account ID#: <?php echo $data['admin_id'];?></h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?php echo BASE_URL.ADMIN_DIR?>/users/administrator">Users</a></li>
              <li class="breadcrumb-item active">Account ID#: <?php echo $data['admin_id'];?></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <div class="card-body box-profile">
                <div class="text-center">
                  <img class="profile-user-img img-fluid img-circle"
                       ...
                       alt="<?php echo $data['admin_id'];?>">
                 </div>
                <h3 class="profile-username text-center"><?php echo $data['first_name']." ".$data['last_name'];?></h3>
                <p class="text-muted text-center"><span class="badge badge-info"><?php echo $data['role']?></span></p>
...
<!--                <strong><i class="fas fa-map-marker-alt mr-1"></i> Location</strong>
                <p class="text-muted"><?php echo ($admin_city!="NO_DATA")?$admin_city['city_name']:"";?></p>
                <hr>-->
  ...
  <!-- /.content-wrapper -->
      ...
      <?php
      include_once __DIR__.'/edit_admin_profile.php';
      ?>
