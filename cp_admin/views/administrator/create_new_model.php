             ...
             <div class="modal-body">
                 <form class="" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-group row">
                    ...
                    <input type="text" name="mobile" class="form-control" maxlength="12" minlength="12"  required="">
                    </div>
                    <div class="col-sm-4">
                 ...
                 <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                    <label class="text-primary"><i class="fa fa-briefcase"></i> Role</label>
                    <select class="form-control select2" name="role" required="">
                        <option value="">Select Role</option>
                        <?php
                        echo $view->selectAdminType();
                        ?>
                    </select>
                    </div> 
                   </div>     
                     
               <button  type="submit" name="createNewAdmin" class="btn btn-primary btn-user btn-block">
