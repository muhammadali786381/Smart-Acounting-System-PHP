            ...
            <span aria-hidden="true">×</span>
             ...
             <div class="modal-body">
                 ...
                 <div class="form-group row">
                    ...
                    <div class="form-group row">
                    <div class="col-sm-12">
                    <label class="text-primary"><i class="fas fa-university"></i> Bank</label>
               ...
               <button  type="submit" name="createNewBankReceicedVoucher" class="btn btn-primary btn-user btn-block">
