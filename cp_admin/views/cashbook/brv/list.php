          ...
          <div class="col-12">
           <div class="card <?php echo $view->app_config("APP_TABLE_HEAD_COLOR_CLASS");?>">
              <div class="card-header">
                <h3 class="card-title">Bank Received Voucher</h3>
              ...
              <div class="card-body">
                <table id="list" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td><?php echo currency_format($row['extra_amount']);?></td>
                    <td><?php echo currency_format($row['amount']+$row['extra_amount']);?></td>
