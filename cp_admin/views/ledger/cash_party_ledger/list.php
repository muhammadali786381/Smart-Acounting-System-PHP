              ...
              <div class="row">
                <div class="col-12">
                    <h3 style="text-align:center;">
                     <?php echo $get_party_detail['company_name'];?>
                    </h3>
              ...
              <div class="row">
               ...
               <table id="list" class="table table-striped table-bordered">
                      ...
                      foreach ($data as $row):
                            if($row['company_id']==$_SESSION['selectCompnayId']):
                              ...
                              if($row['cr_head_id']==$party_id || $row['dr_head_id']==$party_id):
                                ...
                                $cr_party_detail=$main->getSingleRecord("account_head","id",$row['cr_head_id']);
                                $dr_party_detail=$main->getSingleRecord("account_head","id",$row['dr_head_id']);
                  ...
                  <tr>
                      ...
                      <td><?php echo ($row['cr_head_id']==$party_id)? "<b>".$dr_party_detail['company_name']."</b>":"<b>".$cr_party_detail['company_name']."</b>"; echo "<br>".$row['note'];?></td>
