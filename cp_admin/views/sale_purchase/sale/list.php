          ...
          <div class="col-12">
           <div class="card <?php echo $view->app_config("APP_TABLE_HEAD_COLOR_CLASS");?>">
              <div class="card-header">
               <h3 class="card-title">Sale Voucher List</h3>
              ...
              <div class="card-body">
                <table id="list" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                     <a href="<?php echo BASE_URL.ADMIN_DIR."/sview/".$row['id']?>" class="btn btn-sm btn-success" target="__blank"  title="View"><i class="fas fa-eye fa-sm text-white-100"></i></a>&nbsp; 
                    </td>
                   </tr>
