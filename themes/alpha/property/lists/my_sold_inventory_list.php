  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Inventory Sold Out By Me</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?php echo BASE_URL; ?>dashboard">Home</a></li>
              <li class="breadcrumb-item active">Inventory Sold Out By Me</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
           <div class="card card-success">
              <div class="card-header">
                <h3 class="card-title">Inventory Sold Out By Me</h3>
              ...
              <div class="card-body">
                <table id="list" class="table table-bordered table-striped">
                  ...
                  <tbody>
                      ...
                      if($data!="NO_DATA"):
                         foreach ($data as $row):
                          if($row['property_post_status_id']=="4"):
                          //get project detail
