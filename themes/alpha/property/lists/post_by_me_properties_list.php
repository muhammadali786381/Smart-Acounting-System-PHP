        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">My Inventory List</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
           <div class="card card-success">
              <div class="card-header">
                <h3 class="card-title">My Inventory List</h3>
              ...
              <div class="card-body">
                <table id="list" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <a href="<?php echo BASE_URL;?>editproperty/<?php echo $row['id']; ?>"  title="Edit" class="btn btn-outline-danger m-1"><i class="fa fa-edit"></i> Edit Details</a>
                    </td>
                  </tr>
